...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.querySelectorAll('.view-3d-btn').forEach(btn => {
    btn.addEventListener('click', (e) => {
      ...
      if (vehicleData.includes('moto') || vehicleData.includes('babayaga')) {
        vehicleType = 'moto';
      } else if (vehicleData.includes('barrage') || vehicleData.includes('camion')) {
        vehicleType = 'camion';
      }
  ...
  document.querySelector('.close-3d').addEventListener('click', close3DViewer);
  document.getElementById('viewer3d-modal').addEventListener('click', (e) => {
